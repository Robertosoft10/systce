<?php
session_start();
$x = 'Cadastrou disciplina do(a) estudante';
...
$matric_estud_cod = $_GET['id_matric'];
$disciplina_cod = $_POST['disciplina_cod'];

$sql = "INSERT INTO  tb_disciplina_estud(matric_estud_cod, disciplina_cod)VALUES('$matric_estud_cod', '$disciplina_cod')";
              ...
              <div class="modal-dialog"  id="posicao-modal">
                <div class="modal-content"  id="tamanho-modal">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-center">
                        <small id="pergunta-modal"> <?= $_SESSION['discipAdd'];?></small><br><br>
                         <a href="../View/detalhe_matricula.php?id_matric=<?= $id_matric;?>">
              ...
              <div class="modal-dialog"  id="posicao-modal">
                <div class="modal-content"  id="tamanho-modal">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-center">
                        <small id="pergunta-modal"> <?= $_SESSION['discipAddErro'];?></small><br><br>
                         <a href="../View/detalhe_matricula.php?id_matric=<?= $id_matric;?>">
                         <button id="btn-modal" class="btn btn-primary"><i class="fa fa-thumbs-o-up"></i> Ok</button></a>
                         </div>
                        </div>
