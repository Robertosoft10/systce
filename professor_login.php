           ...
           <button class="btn btn-primary btn-sm">Admin</button></a>
            ...
            <br>
              <fieldset>
                  ...
                  <form action="Persistence/autentic_usuario_prof.php" method="post">
                  <div class="form-group col-md-12 text-left">
                  <div class="col-sm-12">
                      <input type="email" name="email_prof" class="form-control" id="inputEmail3" placeholder="E-mail">
				    </div>
				     </div>
                    <div class="form-group col-md-12 text-left">
				    <div class="col-sm-12">
...
<!-- ===== alert erro =====-->
  <?php if(isset($_SESSION['loginProfVazio'])){?>
    ...
    $('.toastrDefaultError').ready(function() {
      toastr.error('<?= $_SESSION['loginProfVazio'];?>')
    });
  });
  </script>
  <?php unset($_SESSION['loginProfVazio']); }?>
  <!-- ===== fim alert erro =====-->
             
<!-- ===== alert erro =====-->
  <?php if(isset($_SESSION['loginProfIncorreto'])){?>
    <script type="text/javascript">
    $(function() {
    const Toast = Swal.mixin({
      toast: true,
    ...
    $('.toastrDefaultError').ready(function() {
      toastr.error('<?= $_SESSION['loginProfIncorreto'];?>')
    });
  });
  </script>
  <?php unset($_SESSION['loginProfIncorreto']); }?>
  <!-- ===== fim alert erro =====-->
...
<script type="text/javascript">
  ...
  <!-- ===== fim alert insert =====-->
      <!-- ===== alert backup =====-->
<?php if(isset($_SESSION['backupOk'])){?>
<script type="text/javascript">
  $(function() {
    const Toast = Swal.mixin({
      toast: true,
    ...
    $('.toastrDefaultSuccess').ready(function() {
      toastr.success('<?= $_SESSION['backupOk'];?>')
    });
  });
  </script>
  <?php unset($_SESSION['backupOk']); }?>
  <!-- ===== fim alert backup =====-->
           
<!-- ===== alert backup erro =====-->
  <?php if(isset($_SESSION['backupErro'])){?>
    <script type="text/javascript">
    $(function() {
    const Toast = Swal.mixin({
      toast: true,
    ...
    $('.toastrDefaultError').ready(function() {
      toastr.error('<?= $_SESSION['backupErro'];?>')
    });
  });
  </script>
  <?php unset($_SESSION['backupErro']); }?>
