...
$matricula = $_GET['id_matric'];
$dia_freq = $_POST['dia_freq'];
$data_freq = $_POST['data_freq'];
$status_freq = $_POST['status_freq'];

$sql = "INSERT INTO tb_frequencias(matricula, dia_freq, data_freq, status_freq)
VALUES('$matricula', '$dia_freq', '$data_freq', '$status_freq')";
              ...
              <div class="modal-dialog"  id="posicao-modal">
                <div class="modal-content"  id="tamanho-modal">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-center">
                        <small id="pergunta-modal"> <?= $_SESSION['chamadaAdd'];?></small><br><br>
              ...
              <div class="modal-dialog"  id="posicao-modal">
                <div class="modal-content"  id="tamanho-modal">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-center">
                        <small id="pergunta-modal"> <?= $_SESSION['chamadaAddErro'];?></small><br><br>
                         <a href="../View/detalhe_matricula.php?id_matric=<?= $id_matric;?>">
                         <button id="btn-modal" class="btn btn-primary"><i class="fa fa-thumbs-o-up"></i> Ok</button></a>
                         </div>
                        </div>
