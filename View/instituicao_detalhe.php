...
<html>
  ...
  <body>
    ...
    <div class="page-content">
		  ...
		  <div class="col-md-9">
  			...
  			<div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title"><i class="fa fa-university"></i> Detalhe da Instituição 
                    </div>
				</div>
  				<div class="panel-body">
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
						<thead>
							<tr id="th-tabela">
								<th id="foto-list-tabela-detalhe">Logo</th>
								<th>Informações</th>
							</tr>
						</thead>
						<tbody>
							<tr class="odd gradeX">
								<td>
                                  <img id="img-detalhe-tabela" src="<?= "../Images/instituicao/".$line_inst->getLogo_instituicao();?>" alt="" class="img-circle img-fluid col-md-12 col-sm-12 col-xs-12">
                                </td>
								<td id="nome-informacao">
                                  Instituicao: <?= $line_inst->getNome_instituicao();?><br>
                                  Contato 1: <?= $line_inst->getFone1_instituicao();?><br>
                                  Contato 2: <?= $line_inst->getFone2_instituicao();?><br>
                                  Email: <?= $line_inst->getEmail_instituicao();?><br>
                                  Endereço: <?= $line_inst->getEndereco_instituicao();?><br>
                                  Direção: <?= $line_inst->getDirecao_instituicao();?><br>
                                  Frase de Destaque: <?= $line_inst->getFrase_instituicao();?><br>
                                    <div id="btn-acao-detalhe">
                                    <hr>
                                    <a id="icon-list-tabela" href="instituicao.php?id_inst=<?= $line_inst->getId_inst();?>">
                                    <i class="fa fa-pencil"></i></a>
                                     
                                    <a id="icon-delt-tabela" href="" data-toggle="modal" data-target="#modal-delete<?= $line_inst->getId_inst();?>">
                                ...
                                <tr>
                                <td colspan="2">
                                   <small id="nome-img-detalhe"> Alterar Logomarca</small>
                                <form action="../Controller/update_foto_instituicao.php?id_inst=<?= $line_inst->getId_inst();?>" method="post" enctype="multipart/form-data">
                                  <div class="input-group form">
                                       <input type="file" name="logo_instituicao" class="form-control" required="">
        ...
        <!-- ========== modal delete ========-->
        <div class="modal fade" id="modal-delete<?= $line_inst->getId_inst();?>">
        <div class="modal-dialog"  id="posicao-modal">
          <div class="modal-content"  id="tamanho-modal">
            ...
            <a href="../Controller/delete_instituicao.php?id_inst=<?= $line_inst->getId_inst();?>">
