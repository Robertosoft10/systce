...
if(!empty($_POST['prof'])){
$matric = $_GET['id_matric'];
$prof = $_POST['prof'];

$sql = "INSERT INTO tb_professor_estud(matric, prof)
VALUES('$matric', '$prof')";
$execute = mysqli_query($conexao, $sql);
    

    $_SESSION['profEstudSalva'] = "Professor(a) adicionado com sucesso!";
}else{
    $_SESSION['profEstudSalvaErro'] = "Falha preencha os campos obrigatórios!";
}
?>
<!DOCTYPE html>
<html>
              ...
              <div class="modal-dialog"  id="posicao-modal">
                <div class="modal-content"  id="tamanho-modal">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-center">
                        <small id="pergunta-modal"> <?= $_SESSION['profEstudSalva'];?></small><br><br>
                         <a href="../View/detalhe_matricula.php?id_matric=<?= $matric;?>">
                         <button id="btn-modal" class="btn btn-primary"><i class="fa fa-thumbs-o-up"></i> Ok</button></a>
                         </div>
                        </div>
                    </div>
                    </div>
        <!-- ========== modal erro cadastro professor ========-->
              ...
              <div class="modal-dialog"  id="posicao-modal">
                <div class="modal-content"  id="tamanho-modal">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-center">
                        <small id="pergunta-modal"> <?= $_SESSION['profEstudSalvaErro'];?></small><br><br>
                         <a href="../View/detalhe_matricula.php?id_matric=<?= $matric;?>">
                         <button id="btn-modal" class="btn btn-primary"><i class="fa fa-thumbs-o-up"></i> Ok</button></a>
                         </div>
                        </div>
...
<?php 
if($_SESSION['profEstudSalva'] == true){
  ?>
